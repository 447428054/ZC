...
class SpiderMain(object):
    ...
    def craw(self, root_url):
        ...
        with open(r'F:\github\WBFL\uploadpath\output\output2.txt', 'w', encoding='utf-8') as f1:
            while self.urls.has_new_url():
                try:  # 由于有些url已经失效，进行下载会异常，故而进行异常捕获
                    ...
                    print(new_data['summary'].replace('\n', '\\n'))
                    f1.write(new_data['summary'].replace('\n', '\\n')+'\n')
                    if count == 50:
                        break
...
def Spide():
    ...
    with open(r'F:\github\WBFL\uploadpath\output\wordlistOutput.txt', 'r', encoding='utf-8') as f:
